...
public class CharacterDataInitializer implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
                ...
                characterRepository.createRelationship(protagonist.getId(), helper.getId(), dummyProjectId,
                                java.util.List.of("ally"), 5,
                                "Trusted companion", false);
                characterRepository.createRelationship(protagonist.getId(), antagonist.getId(), dummyProjectId,
                                java.util.List.of("enemy"), -5,
                                "Destined rival", false);
                characterRepository.createRelationship(antagonist.getId(), protagonist.getId(), dummyProjectId,
                                java.util.List.of("enemy"), -5,
